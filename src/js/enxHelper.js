...
var EnxHelper = new function() {
    ...
    this.PreDealEnxContent = function(strEnxContent) {
        return strEnxContent.replace(new RegExp(this.GlobalVar.XMLTAG, "gm"), "").replace(new RegExp(EnxHelper.GlobalVar.IllegalTagEnd, "gm"), EnxHelper.GlobalVar.LawfulTagEnd).replace(new RegExp(EnxHelper.GlobalVar.LinkTag, "gm"), EnxHelper.GlobalVar.LinkTagReplace);
    };
    //Enx文件转Json列表 
